...
class TestMessageCreation:
    ...
    def test_message_header_nonce_valid(self):
        ...
        msg = create_message(agent_id="agent-001", msg_type="event", data={})
    ...
    def test_create_multiple_messages(self):
        ...
        for i in range(10):
            msg = create_message(
                agent_id=f"agent-{i:03d}", msg_type="event", data={"index": i}
            )
            messages.append(msg)
...
class TestMessageDataFormats:
    ...
    def test_message_with_nested_data(self):
        ...
        data = {
            "event": {
                "type": "file_access",
                "file": {"path": "/tmp/honey.txt", "size": 1024},
                "user": {"name": "attacker", "id": 1001},
            }
        }

        msg = create_message(agent_id="agent-001", msg_type="event", data=data)
    ...
    def test_message_with_numeric_data(self):
        ...
        data = {"integer": 42, "float": 3.14159, "negative": -100, "zero": 0}
    ...
    def test_message_with_boolean_data(self):
        ...
        data = {"is_active": True, "has_error": False, "verbose": True}
